...
// Double (camxiom::omnidirectional ::*64) projection API. Thin <double>
// instantiations of the scalar-templated core in
// omnidirectional/projection_impl.hpp; the math is shared with the float path
// in omnidirectional/projection.cpp.
