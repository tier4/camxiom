...
#include "omnidirectional/projection_impl.hpp"

// Float (camxiom::omnidirectional) projection API. The math now lives once in
// the scalar-templated core (omnidirectional/projection_impl.hpp); these are
// the <float> instantiations. The double counterparts live in
// omnidirectional/projection64.cpp.
