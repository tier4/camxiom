...
// Float (camxiom::pinhole) projection API. The math now lives once in the
// scalar-templated core (pinhole/projection_impl.hpp); these are the <float>
// instantiations. The double counterparts live in pinhole/projection64.cpp.
