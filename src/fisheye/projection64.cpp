...
// Double (camxiom::fisheye ::*64) projection API. Thin <double> instantiations
// of the scalar-templated core in fisheye/projection_impl.hpp; the math is
// shared with the float path in fisheye/projection.cpp.
