...
#include "eucm/projection_impl.hpp"

// Float (camxiom::eucm) projection API. The math now lives once in the
// scalar-templated core (eucm/projection_impl.hpp); these are the <float>
// instantiations. The double counterparts live in eucm/projection64.cpp.
