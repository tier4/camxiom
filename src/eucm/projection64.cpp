...
// Double (camxiom::eucm ::*64) projection API. Thin <double> instantiations of
// the scalar-templated core in eucm/projection_impl.hpp; the math is shared
// with the float path in eucm/projection.cpp.
