...
#include "double_sphere/projection_impl.hpp"

// Float (camxiom::double_sphere) projection API. The math now lives once in the
// scalar-templated core (double_sphere/projection_impl.hpp); these are the
// <float> instantiations. The double counterparts live in
// double_sphere/projection64.cpp.
