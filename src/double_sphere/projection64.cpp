...
// Double (camxiom::double_sphere ::*64) projection API. Thin <double>
// instantiations of the scalar-templated core in
// double_sphere/projection_impl.hpp; the math is shared with the float path in
// double_sphere/projection.cpp.
